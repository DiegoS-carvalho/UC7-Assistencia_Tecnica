...
namespace AssistenciaTec.Data
{
    ...
    {
        private static readonly string ConexaoString = @"Server=OSA0716387W11-1\SQLEXPRESS;Database=db_assistencia;Trusted_Connection=True;TrustServerCertificate=True;";
